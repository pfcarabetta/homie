...
import dispatchAllowanceRouter from './routes/dispatch-allowance';
...
app.use('/api/v1/account/dispatch-allowance', apiLimiter, requireAuth, dispatchAllowanceRouter);
app.use('/api/v1/account/dashboard', apiLimiter, requireAuth, dashboardRouter);
...
app.use('/api/v1/booking-messages', bookingMessagesPublicRouter);
