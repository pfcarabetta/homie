...
import {
  correlateItemToChat,
  itemCorrelatesWithChat,
  inventoryFromPropertyDetails,
  mergedInventory,
  dedupeInventory as dedupePropertyInventory,
  iqLabelFor,
...
// Correlation helpers, synonym + generic-token tables, form-to-inventory
// mapper, merge, and dedupe have moved to @/utils/home-iq so the consumer
// quote chat can share the same logic for its "Home IQ" panel. Imports at
