...
// ── Tab Types ────────────────────────────────────────────────────────────────
export const TABS = ['dashboard', 'dispatches', 'bookings', 'guest-requests', 'schedules', 'reports', 'properties', 'vendors', 'team', 'settings', 'billing'] as const;
export type Tab = typeof TABS[number];
export const TAB_LABELS: Record<Tab, string> = {
  dashboard: 'Dashboard', dispatches: 'Dispatches', bookings: 'Bookings',
  'guest-requests': 'Guest Requests', schedules: 'Auto-Dispatch', billing: 'Billing',
