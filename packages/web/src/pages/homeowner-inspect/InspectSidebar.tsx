...
function getNavItems(): NavItem[] {
  return [
    ...
    { id: 'home-iq', label: 'Home IQ', icon: 'home-iq', tab: 'home-iq' },
...
function Icon({ name, size = 20 }: { name: string; size?: number }) {
  ...
  const icons: Record<string, JSX.Element> = {
    ...
    'home-iq': <svg style={s} viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M10 2.5C7 2.5 4.8 4.5 4.8 7.2c0 1.4.6 2.6 1.6 3.5v2.3c0 .6.5 1 1 1h5.2c.5 0 1-.4 1-1v-2.3c1-.9 1.6-2.1 1.6-3.5 0-2.7-2.2-4.7-5.2-4.7z"/><path d="M7.4 16.5h5.2M8.4 18.5h3.2"/></svg>,
